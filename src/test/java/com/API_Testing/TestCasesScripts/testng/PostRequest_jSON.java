 ...
 * @author 			:	 sumitkumar
 *	DATE       		:	 07-Jul-2019
 *  FILE NAME  		: 	 PostRequest_jSON.java
...
import com.API_Testing.TestCasesScripts.mainmethod.CreateBodyUsingJson;
...
public class PostRequest_jSON 
{
	@Test
	public void postJsoneBody()
	{
		CreateBodyUsingJson jsoBody = new CreateBodyUsingJson();
